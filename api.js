...
const DEFAULT_USER = { username: "joelsongsouzza", password: "mytestpassword" }
...
const app = http.createServer(handler).listen(3000, () => console.log('app running on port 3000'));
